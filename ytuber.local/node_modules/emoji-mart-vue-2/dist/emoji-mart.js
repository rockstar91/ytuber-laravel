...
function sanitize(emoji) {
  ...
  var locked = emoji.locked;
  var sizeType = emoji.sizeType;
...
exports.default = {
  ...
  methods: {
    getIconStyle: function getIconStyle(category) {
      if (!this.icons[category.id] && !category.iconUrl) {
        return {};
      }
      return {
        backgroundImage: 'url(' + (this.icons[category.id] || category.iconUrl) + ')'
      };
    }
  }
}; //
...
exports.default = {
  ...
  computed: {
    ...
    isLockedGroup: function isLockedGroup() {
      if (!this.emojis || this.emojis.length <= 0) {
        return false;
      }
      return this.emojis.every(function (item) {
        return item.locked;
      });
    }
  },
      ...
      handler: function handler(val) {
        ...
        if (val.length <= 50) {
          this.$nextTick(function () {
            _this.renderEmojis = val;
          });
          return;
        }
        this.$nextTick(function () {
          _this.renderEmojis = val.slice(0, 50);
...
exports.default = {
  ...
  computed: {
    ...
    unlockMaskStyle: function unlockMaskStyle() {
      return {
        width: this.size + 'px',
        height: this.size + 'px',
...
function makeCustomCategory(customObj) {
  return (0, _assign2.default)({}, customObj, {
    id: customObj.id || customObj.category || '',
    emojis: customObj.emojis ? customObj.emojis.map(makeCustomEmoji) : customObj.list ? customObj.list.map(makeCustomEmoji) : []
  });
}
...
exports.default = {
  ...
  data: function data() {
    ...
    var customEmojis = this.custom.map(makeCustomEmoji),
        multiCustomEmojis = this.multiCustom.map(makeCustomCategory),
        recentEmojis = this.recent || _frequently2.default.get(this.perLine);
    var categoriesNameFromJson = {};
    ...
    if (recentEmojis.length) {
      recentEmojis = recentEmojis.map(function (id) {
        ...
        try {
          for (var _iterator2 = (0, _getIterator3.default)(multiCustomEmojis), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var multiCustomCategory = _step2.value;
            var _iteratorNormalCompletion3 = true;
            var _didIteratorError3 = false;
            var _iteratorError3 = undefined;

            try {
              for (var _iterator3 = (0, _getIterator3.default)(multiCustomCategory.emojis), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                var multiCustomEmoji = _step3.value;

                if (multiCustomEmoji.id === id) {
                  return multiCustomEmoji;
                }
              }
            } catch (err) {
    ...
    recentEmojis = recentEmojis.filter(function (item) {
      if (_this.onlyMultiCustom) {
        return typeof item !== 'string';
      }
      if (_this.onlyBuiltin) {
        return typeof item === 'string';
      }
      return true;
    });
    ...
    if (this.emojisToShowFilter) {
      ...
      multiCustomEmojis.forEach(function (item) {
        item.emojis = item.emojis.filter(function (e) {
          return _this.emojisToShowFilter(_this.mutableData.emojis[e] || e);
        });
        categoriesNameFromJson[item.id] = item.name;
      });
    ...
    I18N.categories = (0, _assign2.default)(I18N.categories, categoriesNameFromJson, this.i18n.categories);
    ...
    return {
      ...
      multiCustomEmojis: multiCustomEmojis,
  ...
  computed: {
    ...
    filteredCategories: function filteredCategories() {
      ...
      return this.categories.filter(function (category) {
        ...
        var hasEmojis = category.emojis && category.emojis.length > 0;
    ...
    renderBuiltinCategories: function renderBuiltinCategories() {
      return this.filteredCategories.filter(function (item) {
        return item.id === 'recent' || !item.custom;
      });
    },
    renderMultiCustomCategories: function renderMultiCustomCategories() {
      return this.filteredCategories.filter(function (item) {
        return item.id === 'recent' || item.custom;
      });
    },
    filterCategoriesByMode: function filterCategoriesByMode() {
      if (this.onlyMultiCustom) {
        return this.renderMultiCustomCategories;
      }
      if (this.onlyBuiltin) {
        return this.renderBuiltinCategories;
      }
  ...
  created: function created() {
    ...
    (_categories = this.categories).push.apply(_categories, (0, _toConsumableArray3.default)(this.multiCustomEmojis));
    (_categories2 = this.categories).push.apply(_categories2, (0, _toConsumableArray3.default)(categories));

    this.categories[0].first = true;
    this.activeCategory = this.filterCategoriesByMode[0];
  },
  mounted: function mounted() {
  ...
  methods: {
    ...
    onScrollPaint: function onScrollPaint() {
      ...
      var scrollTop = this.$refs.scroll.scrollTop,
          activeCategory = this.filterCategoriesByMode[0];

      for (var i = 0, l = this.filterCategoriesByMode.length; i < l; i++) {
        var category = this.filterCategoriesByMode[i],
    ...
    onAnchorClick: function onAnchorClick(category) {
      ...
      var i = this.filterCategoriesByMode.indexOf(category),
          component = this.$refs.categories[i],
      ...
      if (this.searchEmojis) {
        ...
        this.activeCategory = this.filterCategoriesByMode[i];
      }
    },
    ...
    onClearClick: function onClearClick() {
      _frequently2.default.clear();
      this.categories.shift();
      this.categories[0].first = true;
      this.activeCategory = this.filterCategoriesByMode[0];
      this.recentEmojis = [];
      this.renderedCategories = [].concat((0, _toConsumableArray3.default)(this.filterCategoriesByMode));
    },
    addRenderCategories: function addRenderCategories() {
      var _this5 = this;

      this.$nextTick(function () {
        _this5.renderedCategories = [_this5.filterCategoriesByMode[0]];
        window.setTimeout(function () {
          _this5.renderedCategories = [].concat((0, _toConsumableArray3.default)(_this5.filterCategoriesByMode));
        }, 0);
      });
    }
  },
...
function clear() {
  _store2.default.set('last', '');
  _store2.default.set('frequently', '');
  initialized = false;
  frequently = '';
  defaults = {};
}
...
function get(perLine) {
  ...
  var quantity = perLine * DEFAULT_ROW;
  var frequentlyKeys = [];
...
exports.default = { add: add, get: get, clear: clear };
  ...
  return _c(
    ...
    _vm._l(_vm.categories, function(category) {
      return _c(
        ...
        [
          (_vm.icons && _vm.icons[category.id]) || category.iconUrl
            ? _c("div", {
                staticClass: "icon",
                style: _vm.getIconStyle(category)
              })
            : _c("div", {
...
// module
exports.push([module.i, "\n.emoji-mart-emoji[data-v-7f853594] {\n  position: relative;\n  display: inline-block;\n  font-size: 0;\n}\n.emoji-mart-emoji.locked[data-v-7f853594]::before {\n  display: none;\n}\n.emoji-mart-emoji .locked-mask[data-v-7f853594] {\n  position: absolute;\n  left: 6px;\n  top: 6px;\n  width: 100%;\n  height: 100%;\n  opacity: 0.7;\n  background-image: linear-gradient(0deg, #000000 5%, #545454 100%);\n  border-radius: 4px;\n  font-size: 14px;\n  color: #FFFFFF;\n  text-align: center;\n  opacity: 0;\n}\n.emoji-mart-emoji:hover .locked-mask[data-v-7f853594] {\n  opacity: .7;\n}\n\n", ""]);
  ...
  return _vm.canRender
    ? _c(
        ...
        [
          ...
          _vm._v(" "),
          !_vm.hideLockMask && _vm.isLocked
            ? _c(
                "span",
                { staticClass: "locked-mask", style: _vm.unlockMaskStyle },
                [_vm._v(_vm._s(_vm.i18n ? _vm.i18n.unlock : ""))]
              )
            : _vm._e()
        ]
      )
  ...
  return _vm.isVisible && (_vm.isSearch || _vm.hasResults)
    ? _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm._l(_vm.renderEmojis, function(emoji) {
            return _c("nimble-emoji", {
              ...
              attrs: {
                ...
                size:
                  emoji.sizeType === "large"
                    ? _vm.emojiProps.sizeL
                    : _vm.emojiProps.size,
                ...
                i18n: _vm.i18n,
                "hide-lock-mask": _vm.emojiProps.hideLockMask
              },
              on: {
                click: _vm.emojiProps.onClick,
                unlock: function(data) {
                  return _vm.$emit("unlock", data)
                },
    ...
    [
            ...
            [
              _c("anchors", {
                attrs: {
                  ...
                  color: _vm.color,
                  categories: _vm.filterCategoriesByMode,
                  "active-category": _vm.activeCategory,
                  icons: _vm.anchorsIcons
                },
      ...
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _vm._l(_vm.renderedCategories, function(category) {
            return _c("category", {
              directives: [
                {
                  name: "show",
